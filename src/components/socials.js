export default function Socials({ compact = false }) {
  return (
    <div className={`flex ${compact ? 'space-x-3' : 'space-x-4 md:space-x-6'}`}>
      <a href="mailto:joerup@princeton.edu" target="_blank" rel="noopener noreferrer" className="transition-transform duration-300 hover:scale-110">
        <svg viewBox="0 0 24 24" className={`${compact ? 'w-5 h-5' : 'w-5 h-5 md:w-6 md:h-6'} fill-current ${compact ? 'text-gray-500' : 'text-gray-600'} dark:text-white hover:text-gray-900 dark:hover:text-gray-300 transition-colors`}>
      ...
      <a href="https://www.youtube.com/@joerup" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center transition-transform duration-300 hover:scale-110">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" clipRule="evenodd" className={`${compact ? 'w-5 h-5' : 'w-6 h-6 md:w-7 md:h-7'} ${compact ? 'text-gray-500' : 'text-gray-600'} dark:text-white hover:text-gray-900 dark:hover:text-gray-300 transition-colors`}>
